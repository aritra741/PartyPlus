...
class _SearchResultGeneratorState extends State<SearchResultGenerator> {
  ...
  List<conventionHall> list = [];
  conventionHall test = new conventionHall("sd", "cc", "SCc", "Khan's Palace Convention Hall", "1", "1110", "1234", "1234", "1335", "https://firebasestorage.googleapis.com/v0/b/fireapp-3d1c4.appspot.com/o/khan.jpg?alt=media&token=267e9cc7-6646-4df0-bceb-a99e1b88360f", 12.3, 12.55);
  //list.add(test);
